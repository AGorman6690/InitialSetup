...
public class JobController {
	...
	@ResponseBody
	public String editJob_deleteWorkDays(HttpSession session, @PathVariable(value = "jobId") int jobId,
	...
	public String findEmployeesForJob(Model model, HttpSession session, @PathVariable(value = "jobId") int jobId) {
	...
	@ResponseBody
	public String replaceEmployee(HttpSession session, @PathVariable(value = "jobId") int jobId,
	...
	@ResponseBody
	public String editJob_workDays(HttpSession session, @RequestBody EditJobDto editJobDto) {
