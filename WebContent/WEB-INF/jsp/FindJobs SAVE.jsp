...
<!-- 			<div class="panel-heading">Filters</div> -->
			...
			<div style="position:relative" class="color-panel panel-body">
							...
							<div class="job-location-container">
								<span class="job-location-label">Number of miles</span> <input value="987987" id="radius"
									type="text" aria-describedby="sizing-addon2">
							</div>
...
<!-- 								<div class="job-location-container input-group"> -->
<!-- 									<span class="job-location-label input-group-addon" -->
<!-- 										id="sizing-addon2">Street Address</span> -->
<!-- 									<input -->
...
<!-- 							<div style="display:inline" class="job-location-container input-group"> -->
<!-- 								<label for="filterStartTime" class="col-sm-2 form-control-label">Start -->
<!-- 									Time</label> -->
<!-- 								<div class="col-sm-10"> -->
...
<!-- 							<div style="display:inline" class="job-location-container input-group"> -->
<!-- 								<label for="filterEndTime" class="col-sm-2 form-control-label">End -->
<!-- 									Time</label> -->
<!-- 								<div class="col-sm-10"> -->
<!-- 									<div style="display:inline"> -->
...
// 			$('#filterStartTime').timepicker({'scrollDefault': '7:00am'});
