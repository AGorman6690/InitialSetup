...
<!-- 				<div class="col-sm-12"> -->
			<div id="additionalFiltersContainer" class="">
				<div class="row">
					...
					<div id="duration" class="col-sm-4 filter-container">								
						<div class="dropdown-header">	
							<span class="remove-filter glyphicon glyphicon-remove"></span>
							<div data-toggle-id="duration-dropdown" data-toggle-speed="2" class="trigger-dropdown">	
			...
			<div class="row">
				<div class="col-sm-4 filter-container" >								
					<div class="dropdown-header">	
						<span class="remove-filter glyphicon glyphicon-remove"></span>
						<div data-toggle-id="start-date-dropdown" data-toggle-speed="2" class="trigger-dropdown">	
				...
				<div class="col-sm-4 filter-container" >								
					<div class="dropdown-header">	
						<span class="remove-filter glyphicon glyphicon-remove"></span>
						<div data-toggle-id="end-date-dropdown" data-toggle-speed="2" class="trigger-dropdown">	
				...
				<div class="col-sm-4 filter-container" >								
					<div class="dropdown-header">	
						<span class="remove-filter glyphicon glyphicon-remove"></span>
						<div data-toggle-id="work-days-dropdown" data-toggle-speed="2" class="trigger-dropdown">	
			...
			<div class="row">
				<div class="col-sm-4 filter-container" >								
					<div class="dropdown-header">	
						<span class="remove-filter glyphicon glyphicon-remove"></span>
						<div data-toggle-id="categories-dropdown" data-toggle-speed="2" class="trigger-dropdown">	
