		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group" style="display: inline">	
					...
					<input style="display: inline" name="radius" type="text"
						class="filter-input form-control" id="radius" placeholder="Number Of"></input>
					<label style="display: inline" for="radius" class="form-control-label">Miles From</label>
					<input style="display: inline" name="radius" type="text"
				...
				<div class="" id="getJobsContainer" style="display: inline">
