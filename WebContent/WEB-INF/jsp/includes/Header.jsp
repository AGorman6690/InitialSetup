...
<head>
	...
	<link href="http://localhost:8080/JobSearch/static/css/bootstrap-datepicker3.standalone.css" rel="stylesheet" />
	<script src="http://localhost:8080/JobSearch/static/External/bootstrap-datepicker.js"></script>
		...
		<ul class="nav navbar-nav">
			...
			<c:choose>
				<c:when test="${user.getProfileId() == 1}">
					<li><a href="http://localhost:8080/JobSearch/jobs/find">Find Jobs</a></li>
				</c:when>
				<c:when test="${user.getProfileId() == 2}">
					<li><a href="http://localhost:8080/JobSearch/employees/find">Find Employees</a></li>
