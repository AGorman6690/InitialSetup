...
<link rel="stylesheet" type="text/css"
	href="/JobSearch/static/css/table.css" />
<link rel="stylesheet" type="text/css"
	href="/JobSearch/static/css/post_job/post_job_new.css" />
<link rel="stylesheet" type="text/css"
	href="/JobSearch/static/css/post_job/post_job_work_days_and_times.css" />
<link rel="stylesheet" type="text/css"
	href="/JobSearch/static/css/post_job/questions.css" />
...
<c:choose>
	...
	<c:otherwise>
		...
		<div id="postSections"
			class="select-page-section-container ${!empty postedJobs ? 'hide-on-load' : '' }">
			<span id="show-general" class="select-page-section selected"
				data-page-section-id="generalContainer">General</span> <span
				id="show-dates-section" class="select-page-section"
				data-page-section-id="datesContainer">Work Days</span> <span
				id="show-availability-section" class="select-page-section"
				data-page-section-id="availabilityContainer">Availability</span> <span
				id="select-times" class="select-page-section"
				data-page-section-id="timesContainer">Times</span> <span
				id="show-positions" class="select-page-section"
				data-page-section-id="positionsContainer">Positions</span> <span
				id="show-location" class="select-page-section"
				data-page-section-id="locationContainer">Location</span>
			<!-- 			<span class="select-page-section" data-page-section-id="categoriesContainer">Categories</span> -->
			<span id="show-questions" class="select-page-section"
				data-page-section-id="questionsContainer">Questions</span> <span
				id="show-skills" class="select-page-section"
				data-page-section-id="employeeSkillsContainer">Employee
				Skills</span>
		</div>
		...
		<div class=" ${!empty postedJobs ? 'hide-on-load' : '' }">
			...
			<div id="preview-job-posting-container">
				<div id="displayExample_jobInfo"></div>
			</div>
			<div id="post-job-container">
				...
				<div id="datesContainer" class="page-section">
					...
					<div class="row">
						...
						<div id="work-days-calendar"
							class="item calendar-container v2 post-job">
							<div class="pad-top">
								<button class="" id="clearCalendar">Clear</button>
							</div>
							<div id="workDaysCalendar_postJob" class="calendar"
				...
				<div id="availabilityContainer" class="page-section">
					<div class="row">
						<div id="is-partial-availability-allowed-question" class="item">
							...
							<div class="radio-container">
								<label data-show-id-on-click="work-days-calendar"><input
									id="yes-partial" type="radio" name="partial-availability">
									Yes</label> <label data-show-id-on-click="work-days-calendar"><input
									id="no-partial" type="radio" name="partial-availability">
									No, they have to apply for all work days</label>
							</div>
						</div>
					</div>
				...
				<div id="timesContainer" class="page-section">
					...
					<p id="no-dates-selected" class="linky-hover pad-top">Please
						select one or more work days</p>
					<div id="initial-time-question" class="item">
						<p class="question-to-job-poster">Is each work day's start
							time and end time the same?</p>
						<div class="radio-container">
							<label data-show-id-on-click="set-one-start-and-end-time"
								data-hide-id-on-click="times-cont"><input
								id="same-times" type="radio" name="same-times"> Yes</label> <label
								data-show-id-on-click="times-cont"
								data-hide-id-on-click="set-one-start-and-end-time"><input
								id="different-times" type="radio" name="same-times"> No,
								at least work one day starts or ends at a different time</label>
						</div>
					</div>
					...
					<div id="times-cont">
						...
						<div class="radio-container pad-top">
							<label><input id="select-all-dates" type="radio"
								name="set-times">Select all dates</label> <label><input
								id="deselect-all-dates" type="radio" name="set-times">Deselect
								all dates</label>
						</div>
						...
						<div
							class="item calendar-container teal-navigation v2 post-job hide-unused-rows">
							<div id="select-times-cal" class="calendar"></div>
						</div>
				...
				<div id="questionsContainer" class="page-section">
					...
					<h3 class="optional-item-explantion">Propose questions to the
				...
				<div id="employeeSkillsContainer" class="page-section">
					<h2 class="optional">Optional</h2>
					<h3 class="optional-item-explantion">List the skills that each
						applicant should have. This is optional, but can help applicants
						decide if they are a good match for your job.</h3>
				...
				<span id="previous-section" class="linky-hover">Previous</span> <span
					id="next-section" class="linky-hover">Next</span>
				<p id="proceed-to-preview-job-posting" class="">Review and
					submit</p>
			</div>
		</div>
	</c:otherwise>
