...
<%@ include file="./includes/Header_Employer.jsp" %>
	...
	<!-- 		<div class="border"  style="position: absolute; top: 200px;" > -->
	<!-- 			<ul id="rate-employees" > -->
	<!-- 			  <li>Cras justo odio</li> -->
	<!-- 			  <li >Dapibus ac facilisis in</li> -->
	<!-- 			  <li >Morbi leo risus</li> -->
	...
	<!-- 	</div> -->
		...
		<button id="submitRating" type="button" class="margin-both2 btn btn-primary">Submit Rating</button>
		
		<br>
		<div id="container" class="">
			<div id="employees" class="margin-both2 rate-employees list-group"></div>
			
			<div class="rate-group criteria1">
				<span class="rate-criteria label label-success">On Time</span>
			...
			<div class="rate-group criteria2">
				<span class="rate-criteria label label-success">Work Ethic</span>
			...
			<div class="rate-group criteria3">
				<span class="rate-criteria label label-success">Hire Again</span>
